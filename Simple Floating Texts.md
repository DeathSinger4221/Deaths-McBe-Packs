...
# [Download v2.1.1](https://www.mediafire.com/file/nv1bsqhrfoyjeop/Simple_Floating_Texts_v2.1.1.mcpack/file#)
...
# **Simple Floating Texts**
  ...
  [<img src="https://github.com/user-attachments/assets/ec4030e8-b5bc-4f1d-bd78-87032069363b" width="40%">](https://www.mediafire.com/file/nv1bsqhrfoyjeop/Simple_Floating_Texts_v2.1.1.mcpack/file#)
...
> [!TIP]
> If your texts are being removed / killed, check for any **/kill** or **/tp** command blocks and add an exception for the `minecraft:egg` entity or the `floating_text` family group.
...
## Features
  * ### Floating Texts
    ...
    <details>
      <summary>Click to Show UI</summary>
...
> In order for your floating text entity to have mutliple lines in it's dispayed text, you just need to instert a `\n` in to the text field.\
  ...
  * ### Editing Floating Scoreboards & Texts
    ...
    <details>
      <summary>Click to Show Example UI</summary>
...
> [!NOTE]
> Some players might still get displayed as "**Offline Player**", they simply need to join the world again to update the name database.
